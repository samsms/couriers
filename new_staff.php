          ...
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 form-group ">
                ...
                <select name="role" id="" class="form-control input-sm select2">
                  <option value=""></option>
                  <?php
                    $roles = $conn->query("SELECT * FROM roles");
                    while($row2 = $roles->fetch_assoc()):
                  ?>
                  <option value="<?php echo $row2['id'] ?>" <?php echo isset($role) && $role == $row2['id'] ? "selected":'' ?>><?php echo $row2['name']?></option>
                <?php endwhile; ?>
                </select>
              </div>
