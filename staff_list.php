		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT u.*,concat(u.firstname,' ',u.lastname) as name, r.name as role, concat(b.street,', ',b.city,', ',b.state,', ',b.zip_code,', ',b.country) as baddress FROM users u left join branches b on b.id = u.branch_id left join roles r on r.id = u.role where u.type = 2 order by concat(u.firstname,' ',u.lastname) asc ");
					...
					<tr>
						...
						<td><?php echo ucwords($row['baddress']) ?></td>
